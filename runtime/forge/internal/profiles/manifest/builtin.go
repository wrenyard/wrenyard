...
var builtinProfiles = []Profile{
	...
	},
	{
		...
		Client:      "codebuddy",
		Provider:    "codebuddy",
		Description: "CodeBuddy (MiniMax M3)",
		Launcher: map[string]any{
			"command":      "codebuddy",
			"default_args": []any{"--model", "minimax-m3"},
		},
		Env:      map[string]string{},
		Settings: map[string]any{},
	},
	{
		...
		Client:      "codebuddy",
		Provider:    "codebuddy",
		Description: "CodeBuddy (Kimi K3)",
		Launcher: map[string]any{
			"command":      "codebuddy",
			"default_args": []any{"--model", "kimi-k3"},
		},
		Env:      map[string]string{},
		Settings: map[string]any{},
	},
	{
		...
		Client:      "codebuddy",
		Provider:    "codebuddy",
		Description: "CodeBuddy (GLM-5.3)",
		Launcher: map[string]any{
			"command":      "codebuddy",
			"default_args": []any{"--model", "glm-5.3"},
		},
		Env:      map[string]string{},
		Settings: map[string]any{},
	},
	{
		...
		Client:      "codebuddy",
		Provider:    "codebuddy",
		Description: "CodeBuddy (GLM-5.3 Flash)",
		Launcher: map[string]any{
			"command":      "codebuddy",
			"default_args": []any{"--model", "glm-5.3-flash"},
		},
		Env:      map[string]string{},
		Settings: map[string]any{},
	},

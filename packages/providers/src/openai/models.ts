import { defineProvider, model, openAI, THINKING_FULL, effortLadder } from '../base/model-defaults.ts';

export const definition = defineProvider({
  id: 'openai', displayName: 'OpenAI', credentialResolver: 'managed', defaultModel: 'gpt-5.6-sol',
  models: [model('gpt-5.6-sol', 1_050_000, 131_072, 'gpt-5.6-sol', THINKING_FULL), model('gpt-5.6-terra', 1_050_000, 131_072, 'gpt-5.6-terra', THINKING_FULL), model('gpt-5.6-luna', 1_050_000, 131_072, 'gpt-5.6-luna', THINKING_FULL)],

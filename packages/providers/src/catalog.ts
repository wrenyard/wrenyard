...
const builtinProviders: readonly ProviderDefinition[] = [
  ...
  },
  {
    ...
    models: [
      model('claude-fable-5', 'Claude Fable 5', 1_000_000, 131_072),
      model('claude-opus-5', 'Claude Opus 5', 1_000_000, 131_072),
      model('claude-sonnet-5', 'Claude Sonnet 5', 1_000_000, 131_072),
      model('claude-haiku-4-5-20251001', 'Claude Haiku 4.5', 200_000, 64_000),
    ],

...
const builtinProviders: readonly RawProviderDefinition[] = [
  ...
  },
  {
    ...
    models: [
      ...
      { ...model('claude-haiku-4-5-20251001', 200_000, 64_000), family: 'claude', claudeTier: 'haiku' },
    ],
  ...
  },
  {
    ...
    models: [
      { ...model('glm-5.3-flash', undefined, undefined, CANONICAL_MODELS['glm-5.3-flash']), capabilities: ['text'], pricing: { inputUsdPerMillion: 0.15, cachedInputUsdPerMillion: 0.03, outputUsdPerMillion: 0.50, source: SRC_OPENCODE_GO, checkedAt: '2026-09-10' } },
      { ...model('glm-5.3', undefined, undefined, CANONICAL_MODELS['glm-5.3']), capabilities: ['text'], pricing: { inputUsdPerMillion: 1.4, cachedInputUsdPerMillion: 0.26, outputUsdPerMillion: 4.4, source: SRC_OPENCODE_GO, checkedAt: '2026-09-10' } },
      { ...model('deepseek-flash', 1_000_000, 384_000), capabilities: ['text', 'image'], intelligence: 'mid', pricing: { inputUsdPerMillion: 0.3, cachedInputUsdPerMillion: 0.006, outputUsdPerMillion: 1.2, source: SRC_OPENCODE_GO, checkedAt: '2026-09-10' } },
      { ...model('hy3'), capabilities: ['text'], pricing: { inputUsdPerMillion: 0.14, cachedInputUsdPerMillion: 0.035, outputUsdPerMillion: 0.58, source: SRC_OPENCODE_GO, checkedAt: '2026-09-10' } },
    ],

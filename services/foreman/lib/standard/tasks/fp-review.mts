...
\`\`\`
`], labels: ["feature_point_set","context"] } as const
...
const definition = {
  ...
  config: {
    ...
    prompt: withTaskPromptTemplates(({ feature_point_set, context = {} }: z.infer<typeof inputSchema>) => renderTaskPromptTemplate(TASK_PROMPT_TEMPLATE_1, [JSON.stringify(feature_point_set, null, 2),

...
`,
`
`], labels: ["featurePointDefinition","topic","project","design_decision","运行时填入任务输入","context"] } as const
...
const definition = {
  ...
  config: {
    ...
    prompt: withTaskPromptTemplates(({
      ...
      design_decision,
      review_feedback = '',
    }: z.infer<typeof inputSchema>) => renderTaskPromptTemplate(TASK_PROMPT_TEMPLATE_1, [featurePointDefinition,
topic,
project,

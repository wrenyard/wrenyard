...
`], labels: ["changes_to_commit","运行时填入任务输入"] } as const
...
const definition = {
  ...
  config: {
    ...
    prompt: withTaskPromptTemplates((input: unknown): string => {
      ...
      return renderTaskPromptTemplate(TASK_PROMPT_TEMPLATE_1, [JSON.stringify(changes_to_commit, null, 2),
String(atomic_commit)])
